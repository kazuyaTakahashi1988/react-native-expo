...
| 検出結果     | Moderate: 27件 / High: 87件 / Critical: 1件             |
...
| ----------------- | ---------------------------- | -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| `axios`           | `1.16.1`                     | Moderate / High            | GHSA-42h9-826w-cgv3<br />GHSA-pmv8-rq9r-6j72<br />GHSA-jqh4-m9w3-8hp9<br />GHSA-mmx7-hfxf-jppx<br />GHSA-f4gw-2p7v-4548<br />GHSA-gcfj-64vw-6mp9<br />GHSA-hcpx-6fm6-wx23<br />GHSA-7q8q-rj6j-mhjq<br />GHSA-mwf2-3pr3-8698<br />GHSA-xj6q-8x83-jv6g | 再帰処理によるDoS、アップロード上限の迂回、プロトタイプ汚染を利用した設定改変など | 未対応（`1.18.0` 以上へ更新）                                                 |
| `form-data`       | `4.0.5`                      | High                       | CVE-2026-12143<br />GHSA-hmw2-7cc7-3qxx                                                                                                                                                                                                              | multipartのフィールド名・ファイル名を介したCRLFインジェクション                   | 未対応（`axios` の間接依存。`4.0.6` 以上へ更新）                              |
...
| `axios`                                     | `^1.15.0`             | `1.16.1`               | 直接依存にModerate / Highあり            |
