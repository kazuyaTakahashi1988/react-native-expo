...
const authConfig: TypeAuthConfig = {
  Auth: {
    Cognito: {
      userPoolId: process.env.EXPO_PUBLIC_AUTH_USER_POOL_ID ?? 'ap-northeast-1_xxxxxxxxx',
      userPoolClientId: process.env.EXPO_PUBLIC_AUTH_USER_POOL_CLIENT_ID ?? 'xxxxxxxxxxxxxxxxxx',
