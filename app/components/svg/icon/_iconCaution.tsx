...
const IconCaution: React.FC<Props> = ({ color = '#000', size = 24 }) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 512 512"
    fill="none"
  >
    <Path d="M509.08,448.217L274.676,42.218c-8.299-14.376-29.051-14.376-37.352,0L2.922,448.217
    ...
    s28.463,3.522,28.463,7.866L273.529,345.11z" fill={color}>
    </Path>
  </Svg>
);
